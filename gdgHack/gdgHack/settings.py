"""
Django settings for gdgHack project.
...
SECRET_KEY = 'django-insecure-y)bb3v6%fg@8mi_yhl(ge@u)y!z%uv&w#nv-1!ap%ofp0%r89t'
...
WSGI_APPLICATION = 'gdgHack.wsgi.application'
